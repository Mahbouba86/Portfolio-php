...
<div class="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-12 px-6">
    ...
    <div class="relative max-w-xs w-full h-[320px] bg-zinc-700 overflow-hidden group rounded-lg shadow-lg">
        ...
        <div class="absolute flex flex-col gap-4 text-white text-base items-center justify-center 
                -bottom-44 right-[-4rem] w-36 h-44 bg-black/60 backdrop-blur-lg 
                transition-all duration-500 group-hover:bottom-0 group-hover:right-0 
                group-hover:w-full group-hover:h-full group-hover:rounded-none z-20">
        <a href="https://github.com/tonprofil" target="_blank" class="hover:underline">GitHub</a>
        <a href="https://dribbble.com/tonprofil" target="_blank" class="hover:underline">Dribbble</a>
        <a href="https://twitter.com/tonprofil" target="_blank" class="hover:underline">Twitter</a>
        </div>
    </div>
